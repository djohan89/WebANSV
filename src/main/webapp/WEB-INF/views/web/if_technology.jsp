		...
		<div class="container">
			<div class="row align-self-center text-center">
				<div class="col-md-8 offset-md-2 text-center breadcrumb-info">
					<h2 class="text-white text-uppercase">Công nghệ thông tin</h2>
				</div>
			</div>
		</div>
	</section>
	<section class="if_information">
		<div class="container">
			<div class="section-1" data-aos="fade-up">
				<h3>
					<b>1.Giải pháp Wifi Tổng thể - Wifi Total Solution</b>
				</h3>
			...
			<div class="section-2 mt-5 mb-5 bg-dak" data-aos="fade-up">
				<h3>
					<b>2.Giải pháp IPCC</b>
				</h3>
				<div class="row mt-5">
					<div class="col-md-6 mt-5 pt-1 " data-aos="fade-left">
						<div class="">
							<p>Công ty hiện đang là đối tác của Genesys trong việc xây
								...
								Platform cho phép quản trị tập trung các thông tin của hệ thống
								bao gồm thông tin tài khoản hệ thống, cấu hình ứng dụng, thông
								tin cuộc gọi, quản trị báo cáo v.v... Các thành phần này có thể
								được quản trị một cách mềm dẻo theo yêu cầu nghiệp vụ của từng
								khách hàng, cho phép quản lý tương tác với người dùng trên cùng
								một giao diện chung duy nhất với các kênh giao tiếp: thoại,
								video, email, chat, SMS, web, mobile, social v.v…</p>
						</div>
					</div>
					<div class="col-md-6 " data-aos="fade-right">
						<img alt="" class="img-fluid"
			...
			<div class="section-3 mt-5 mb-5" data-aos="fade-up">
				<h3>
					<b>3.Giải pháp hạ tầng CNTT và Bảo mật</b>
				</h3>
				<div class="row mt-5">
					<div class="col-md-6" data-aos="fade-right">
						<img alt="" class="img-fluid"
					...
					<div class="col-md-6 mt-5 pt-1 " data-aos="fade-left">
						<div class="">
							...
							<p>Các giải pháp hạ tầng CNTT được kết hợp với các giải pháp
								...
								Phần mềm, Dịch vụ bảo mật.</p>
						</div>
					</div>
				</div>
			</div>
			<div class="section-4 mt-5 mb-5 bg-dak" data-aos="fade-up">
				<h3>
					<b>4.Hệ thống tính cước online - OCS (Online Charging System)</b>
				</h3>
				<div class="row mt-5 ">
					<div class="col-md-6 mt-5 pt-1 " data-aos="fade-left">
						<div class="">
							<p>OCS - hệ thống tính cước online cho thuê bao di động trả
								...
								sẽ giúp nhà mạng quản lý cước online và triển khai nhiều dịch vụ
								tiện ích đến với khách hàng.</p>
						</div>
					</div>
					<div class="col-md-6 " data-aos="fade-right">
						<img alt="" class="img-fluid"
			...
			<div class="section-5 mt-5" data-aos="fade-up">
				<h3>
					<b>5.Trung tâm thông tin, chỉ đạo điều hành </b>
				</h3>
				<div class="row mt-5">
					<div class="col-md-6 " data-aos="fade-right">
						<img alt="" class="img-fluid"
